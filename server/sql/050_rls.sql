...
-- Mutating principals, groups and role definitions is deliberately left with no
-- policy: it is an out-of-band administrative act performed by the migration
-- role or an IdP sync job, not something a wiki client can do.
